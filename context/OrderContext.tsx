...
import { getCurrentUser } from '../services/api'; // Import your auth service
...
export const OrderProvider = ({ children }) => {
    ...
    useEffect(() => {
        const loadUserAndOrders = async () => {
            try {
                ...
                console.error('Erreur lors du chargement de l\'utilisateur et des commandes:', error);
            }
        };
    ...
    const addOrder = async (orderItems) => {
        ...
        const newOrder = {
            id: Date.now(),
            userId: currentUser.id, // Associate the order with the current user
            items: orderItems,
            startTime: now,
